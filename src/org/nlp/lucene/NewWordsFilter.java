...
public class NewWordsFilter extends TokenFilter {
	...
	protected NewWordsFilter(TokenStream input) {
		super(input);
	...
	public boolean incrementToken() throws IOException {
		...
		if (tokenIter == null || !tokenIter.hasNext()) {
			if (input.incrementToken()) {
				...
				tokenBuffer = wordSegmenter.getTokendNewWords(termAtt.toString());				
